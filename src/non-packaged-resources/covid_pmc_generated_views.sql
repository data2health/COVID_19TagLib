...
create view covid_pmc.paragraph_staging_cite_filter as
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<xref(?: [^>]*)?/>', '', 'g') as p
from covid_pmc.paragraph_staging_cite_filter;
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<graphic(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<graphic(?: [^>]*)?>.*</graphic>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<inline-graphic(?: [^>]*)?>.*</inline-graphic>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<mml:mo(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<mml:mn(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<mml:mi(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<mml:maligngroup(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<mml:mrow(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<mml:mprescripts(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<mml:mfenced(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<mml:mstyle(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<mml:mtext(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<mml:none(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<mml:mtd(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<italic(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<mml:mtr(?: [^>]*)?/>', '', 'g') as p
...
select
	pmcid, pmid, seqnum, seqnum2, seqnum3, seqnum4, seqnum5, seqnum6, id,
	orig,
	regexp_replace(p, '<disp-formula(?: [^>]*)?/>', '', 'g') as p
